...
import ru.vladik.myapplication.DiaryAPI.DataClasses.v6.FeedElement;
import ru.vladik.myapplication.DiaryAPI.DataClasses.v6.FeedElement.*;
...
import ru.vladik.myapplication.DiaryAPI.DataClasses.webApi.Likes;
import ru.vladik.myapplication.DiaryAPI.DataClasses.v2.FormatedDate;
...
import ru.vladik.myapplication.DiaryAPI.DataClasses.v2.LessonWithoutWorks;
...
public class DiaryAPI extends DiaryBase {
    ...
    public ImportantRecent getRecentNewsWithSubjectNames(Long personId, Long groupId) {
        ...
        for (ru.vladik.myapplication.DiaryAPI.DataClasses.v6.Mark mark : news.getRecentMarks()) {
    ...
    public ru.vladik.myapplication.DiaryAPI.DataClasses.v6.Likes setLike_v6(String eventKey, String reaction) {
        Type likesType = new TypeToken<ru.vladik.myapplication.DiaryAPI.DataClasses.v6.Likes>() {}.getType();
    ...
    public ru.vladik.myapplication.DiaryAPI.DataClasses.v6.Likes removeLike_v6(String eventKey) {
        Type likesType = new TypeToken<ru.vladik.myapplication.DiaryAPI.DataClasses.v6.Likes>() {}.getType();
